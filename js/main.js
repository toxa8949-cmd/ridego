...
const ADD_SPEC_FIELDS = {
  'Електросамокати': [
    { section:'⚡ Двигун', fields:[
      _fsel('sp-motor-w','Потужність двигуна',['250 Вт','350 Вт','500 Вт','700 Вт','1000 Вт','1200 Вт','1500 Вт','2000 Вт'],true),
      _fsel('sp-voltage','Напруга',['24 В','36 В','48 В','60 В','72 В']),
      _fsel('sp-motor-t','Тип мотора',['Заднє колесо (хаб)','Переднє колесо (хаб)','Подвійний привід']),
    ]},
    { section:'🔋 Акумулятор', fields:[
      _fsel('sp-battery-ah','Ємність батареї',['до 7 Ah','7–10 Ah','10–13 Ah','13–15 Ah','15–20 Ah','20+ Ah'],true),
    ...
    { section:'🏎 Характеристики руху', fields:[
      _fsel('sp-speed','Макс. швидкість',['до 20 км/год','20–25 км/год','25–35 км/год','35–45 км/год','45+ км/год'],true),
      _fsel('sp-range','Запас ходу',['до 20 км','20–40 км','40–60 км','60–90 км','90+ км'],true),
    ...
    { section:'📐 Конструкція', fields:[
      _fsel('sp-wheel','Розмір коліс',['8"','8.5"','10"','10.5"','11"','12.5"'],true),
      ...
      _fnum('sp-weight','Вага самоката (кг)','13'),
  ...
  'Велосипеди': [
    { section:'🚲 Рама', fields:[
      ...
      _fsel('sp-frame-size','Розмір рами',['13"–14" (XS)','15"–16" (S)','17"–18" (M)','19"–20" (L)','21"–22" (XL)','23"+ (XXL)']),
    ]},
    ...
    { section:'🛞 Колеса', fields:[
      _fsel('sp-wheel','Діаметр коліс',['12"','16"','20"','24"','26"','27.5"','28"','29"'],true),
    ...
    { section:'📐 Розміри', fields:[
      _fnum('sp-weight','Вага велосипеда (кг)','11'),
  ...
  'Електровелосипеди': [
    { section:'⚡ Електросистема', fields:[
      _fsel('sp-motor-w','Потужність мотора',['до 250 Вт','250–350 Вт','350–500 Вт','500–750 Вт','750+ Вт'],true),
      ...
      _fsel('sp-battery-ah','Ємність батареї',['до 10 Ah','10–14 Ah','14–17 Ah','17–20 Ah','20+ Ah'],true),
    ...
    { section:'🏎 Їзда', fields:[
      _fsel('sp-speed','Макс. швидкість',['до 25 км/год (EU)','25–35 км/год','35–45 км/год','45+ км/год'],true),
      _fsel('sp-range','Запас ходу (PAS)',['до 40 км','40–60 км','60–80 км','80–120 км','120+ км'],true),
    ...
    { section:'🚲 Рама і колеса', fields:[
      ...
      _fsel('sp-wheel','Розмір коліс',['20"','24"','26"','27.5"','28"','29"','26" Fat','20" Fat'],true),
  ...
  'Електроскутери': [
    { section:'⚡ Двигун', fields:[
      _fsel('sp-motor-w','Потужність двигуна',['до 500 Вт','500–1200 Вт','1200–2000 Вт','2000–5000 Вт','5000+ Вт'],true),
    ...
    { section:'🔋 Акумулятор', fields:[
      _fsel('sp-battery-ah','Ємність (Ah)',['до 20 Ah','20–30 Ah','30–50 Ah','50–80 Ah','80+ Ah'],true),
    ...
    { section:'🏎 Динаміка', fields:[
      _fsel('sp-speed','Макс. швидкість',['до 45 км/год','45–70 км/год','70–100 км/год','100+ км/год'],true),
      _fsel('sp-range','Запас ходу',['до 50 км','50–80 км','80–120 км','120+ км'],true),
  ...
  'Електромотоцикли': [
    { section:'⚡ Електросистема', fields:[
      _fsel('sp-motor-w','Пікова потужність',['до 5 кВт','5–10 кВт','10–20 кВт','20–50 кВт','50–100 кВт','100+ кВт'],true),
      _fsel('sp-motor-cont','Номінальна потужність',['до 3 кВт','3–7 кВт','7–15 кВт','15–40 кВт','40+ кВт']),
    ...
    { section:'🏎 Динаміка', fields:[
      _fsel('sp-speed','Макс. швидкість',['до 80 км/год','80–120 км/год','120–160 км/год','160–200 км/год','200+ км/год'],true),
      _fsel('sp-range','Запас ходу (WLTP)',['до 80 км','80–130 км','130–200 км','200–300 км','300+ км'],true),
      _fsel('sp-accel','Розгін 0–100 км/год',['до 3 с','3–5 с','5–7 с','7–10 с','10+ с']),
    ]},
    { section:'🛞 Шасі', fields:[
    ...
    { section:'📐 Габарити', fields:[
      _fnum('sp-weight','Спорядна маса (кг)','180'),
      ...
      <div class="form-row" style="row-gap:16px;grid-template-columns:repeat(auto-fill,minmax(200px,1fr))">
        ${sec.fields.map(f => `
          <div class="form-group" style="margin-bottom:0">
            <label>${f.label}</label>
            ${f.type === 'select'
              ? `<select class="form-input" id="${f.id}">${f.opts.map((o,i) => `<option value="${o}"${i===0?'':''}">${i===0?'Не вказано':o}</option>`).join('')}</select>`
...
// ── renderMyListings — додати кнопку Просувати ────────────────
