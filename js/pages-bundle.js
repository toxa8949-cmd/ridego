...
function _renderSellerByUid(uid) {
  ...
  function _doRender(listings) {
    ...
    _readPublicProfile(uid).then(function(d) {
      ...
      if (avEl) {
        if (d.photoUrl) {
          avEl.innerHTML = '<img alt="Аватар" src="' + _esc(d.photoUrl) + '" style="width:100%;height:100%;object-fit:cover;border-radius:14px">';
        } else {
  ...
  if (window._db && sellerUid) {
    ...
    if (_cachedSeller) {
      ...
      if (_avEl && _cachedSeller.photoUrl) {
        _avEl.innerHTML = '<img alt="Аватар" src="' + _esc(_cachedSeller.photoUrl) + '" style="width:100%;height:100%;object-fit:cover;border-radius:inherit">';
      }
      ...
      _readPublicProfile(sellerUid).then(function(d) {
        ...
        if (_avEl2 && d.photoUrl) {
          _avEl2.innerHTML = '<img alt="Аватар" src="' + _esc(d.photoUrl) + '" style="width:100%;height:100%;object-fit:cover;border-radius:inherit">';
        }
